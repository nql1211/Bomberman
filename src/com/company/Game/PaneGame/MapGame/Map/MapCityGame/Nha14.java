...
public class Nha14 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha14.png", libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha14(int x, int y) {
        super(x, y);
    }
    @Override
