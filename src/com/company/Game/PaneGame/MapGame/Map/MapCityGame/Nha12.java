...
public class Nha12 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha12.png", libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha12(int x, int y) {
        super(x, y);
    }
    @Override
