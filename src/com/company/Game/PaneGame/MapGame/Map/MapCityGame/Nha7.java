...
public class Nha7 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha7.png", libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha7(int x, int y) {
        super(x, y);
    }
    @Override
