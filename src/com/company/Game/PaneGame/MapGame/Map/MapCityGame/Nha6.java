...
public class Nha6 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha6.png", libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha6(int x, int y) {
        super(x, y);
    }
    @Override
