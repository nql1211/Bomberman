...
public class Nha20 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha20.png", libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha20(int x, int y) {
        super(x, y);
    }
    @Override
