...
public class Nha1 extends OVuong {
    private static Image image = LoadImage.load("image/MapGame/Mapcity/nha1.png",libarary.WidthOVuong,libarary.WidthOVuong);
    public Nha1(int x, int y) {
        super(x, y);
    }
    @Override
